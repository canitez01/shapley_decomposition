...
```
where $i \in M$ and M is the main set of variables and $m=|M|, s=|S|$. For shapley change decomposition, $[V(S \cup \{i_t1\})-V(S\cup \{i_t0\})]$ and s is the number of variables with t1 instance.  
